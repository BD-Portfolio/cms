...
export default function PostCard(props: PostCardProps) {
    ...
    const { setPostSelected, deletePost } = useContext(PostContext);

    const navigateToPostPage = (data: any) => {
        setPostSelected(data);
        router.push(`/posts/fetch/?data=${JSON.stringify(data)}`);
        // router.push(`/posts/fetch/`)
    }
    ...
    return <div
        ...
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Post</h5>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">The details of post is :- </p>
        ...
        {props.showDetailsBtn && <button type="button" onClick={() => navigateToPostPage(props.data)}
        ...
        {props.showDeleteBtn &&
            <button type="button" onClick={() => deletePost(props.data.id)}
        ...
        <button type="button" onClick={() => updatePost(props.data)}
